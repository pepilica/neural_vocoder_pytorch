...
class BaseDataset(Dataset):
    ...
    def get_spectrogram(self, source):
        """
        Special instance transform with a special key to
        get spectrogram from source.

        Args:
            audio (Tensor | str): original audio/text.
        Returns:
    ...
    def _assert_index_is_valid(index):
        ...
        """
        for entry in index:
            assert ("audio_path" in entry or "text" in entry), (
                "Each dataset item should include either field 'audio_path'" 
                " - path to audio file or field 'text'"
